...
window.onscroll = function () {
  ...
  v = document.body.scrollTop || document.documentElement.scrollTop;
  var pageCanvasMarker_rr = document.getElementById("pageMarker_canvas");
  if(v!=undefined && pageCanvasMarker_rr!=undefined){
    if (v + screen.height > pageCanvasMarker_rr.height / 2) {
...
function H() {
  ...
  (new Promise(function (c, e) {
    ...
    chrome.runtime.sendMessage({
      ...
      e.download = "Drawing_" + c + "_pageMarker_.png";
      e.href = screenshot;
